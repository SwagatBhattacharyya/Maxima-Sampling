SinusoidalModulationPrediction.m: Generates the curves shown in Fig. 4 one at a time. Adjust 'wm' and the 'FileName' parameters accordingly for each cure you wish to plot.   
